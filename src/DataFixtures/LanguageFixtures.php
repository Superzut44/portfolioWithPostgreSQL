...
class LanguageFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        // $language->addProject($this->getReference('project_marcheconclu'));
        // $language->addProject($this->getReference('project_unlock'));
        // $language->addProject($this->getReference('project_wildpost'));
