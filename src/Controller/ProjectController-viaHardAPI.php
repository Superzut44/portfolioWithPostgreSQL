        ...
        $projects = [
            [
                ...
                'description' => "Projet de création (du  1 décembre 2021 au 11 février 2022) 
                    d'un site Marché Conclu pour une cliente, en version mobile, à l'école Wild Code School de Reims.",
                ...
                'language' => [
                    [
                        'id' => 1,
                        'name' => 'html',
                        'image' => 'https://cdn.jsdelivr.net/gh/devicons/devicon/
            ...
            [
                ...
                'description' => "Projet de création (du  21 oct au 13 nov 2021) d'un site fictif de type jeu :
                     escape game ( Unlock! Sherlock adventures ) à l'école Wild Code School de Reims.",
            ...
            [
                ...
                'icon' => 'icon8-laptop-and-phone.png',
                'image' => 'wild-post.jpg',
                'description' => "Création (du  28 sept au 8 oct 2021) d'un site fictif de type journal 
                    sur l'école Wild Code School de Reims.",
