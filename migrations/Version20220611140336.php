 ...
 */
final class Version20220611140336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, screen_id INT DEFAULT NULL, name VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, github VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, start_the DATETIME NOT NULL, INDEX IDX_2FB3D0EE41A67722 (screen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
